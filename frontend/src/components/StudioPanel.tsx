          ...
          {showAnswer && (
            <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-6">
              <div className="flex items-center justify-between mb-3">
                <div className="text-xs text-green-400 uppercase tracking-wider">Model Answer</div>
                <div className="text-xs text-green-400">({currentQ.marks} marks)</div>
              </div>
              <div className="text-white mb-4">{currentQ.model_answer}</div>
              
              {currentQ.key_points && currentQ.key_points.length > 0 && (
                <div className="mt-4">
                  <div className="text-xs text-green-400 uppercase tracking-wider mb-2">Key Points (Marking Scheme)</div>
                  <ul className="space-y-1">
                    {currentQ.key_points.map((point, i) => (
